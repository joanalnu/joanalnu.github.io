...
Joan Alcaide-Núñez is a BSc physics student at LMU Munich with a strong interest in multi-messenger cosmology, which consist of combining electromagnetic and gravitational-wave astronomical observation to test our understanding of the universe. He is particularly interested in the Hubble tension and probing the physical nature of dark energy.

Between 2023 and 2025 (last years of high school), Joan pursued  series of summer research projects centered on the cosmic distance ladder, recomputing the Hubble constant using Cepheids and then Type Ia Supernovae. Building on this foundation, he began to learn about multi-messenger approaches by exploring how gamma-ray bursts (GRBs) and gravitational-wave observations can be jointly used to constrain cosmological parameters, independetly of and complementary to standard probes. These projects introduced him early to research-level data analysis and stregthened his mathematical, programming and statistical skills beyond the high school curriculum.

After the Youth \& Science fellowship, Joan has continued to develop his research interests in multi-messenger cosmology and dark energy, extending previous work in free time. In particular, he has been lately focusing in understanding the data ..... and bayesian inference with Monte carlo (extending from chi2 to more parameters) also with the intention to test other models such as w0wa
